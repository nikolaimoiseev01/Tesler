<header id="header">
    <div class="content header_wrap">
        <div class="left_block">
            <svg id="good_cart_header_button" width="21" height="22" viewBox="0 0 21 22" fill="none"
            ...
            @livewire('portal.comp-choose')
        </div>
        <x-logo/>
        <div class="right_wrap">
            <a href="{{ENV('YCLIENTS_ONLINE_LINK')}}" target="_blank"
               class="link_for_main_sign link coal">ЗАПИСАТЬСЯ</a>
            <x-ui.menu-mobile/>
        </div>
    </div>
