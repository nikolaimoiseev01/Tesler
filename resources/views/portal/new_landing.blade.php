...
@section('content')
            ...
            <div class="top_wrap ">
                <div class="left_wrap">
                    ...
                    <ul>
                        ...
                        <li>чувственный комплект от INTENSO Lingerie из новой коллекции;</li>
    ...
    <div class="desc_3_wrap">
        <div class="content">
            ...
            <p>
                Посетите салон TESLER BEAUTY с 11 по 17 февраля, записавшись на любую процедуру. Чем большее количество
                процедур Вы выбираете, тем больше именных жетонов вам присваивается. Дополнительные услуги также
                учитываются. Количество визитов в течение указанного периода не ограничено. 17 февраля мы раскручиваем
