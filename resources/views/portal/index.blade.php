...
@section('content')
    ...
    <div class="content about_wrap">
        <div class="text">
            <p>О НАС</p>
            <h2> Tesler – салон, с заботоЙ about </h2>
            <div>
                <p>Мы — не просто салон, а настоящий Дом Красоты. <br>
                    У нас вы найдёте практически любую услугу, чтобы почувствовать себя королевой, а также сможете
                    насладиться сервисом, зарядиться энергией и просто расслабиться.
                </p>
                <p>
                    Мы — профессионалы. Здесь каждый мастер знает и любит своё дело, постоянно самосовершенствуется,
                    обладает невероятной эмпатией и следит за мировыми трендами. Добро пожаловать в Tesler!
                </p>
            </div>
        </div>
    ...
    <div class="content two_parts_block_wrap">
        ...
        <div class="right">
            ...
            <p>
                ...
                воздуха в салоне, тв-контенте по душе, комфортных удобных креслах и, конечно, всегда рады угостить вас
                идеальной чашечкой кофе.
                </br></br>
                Tesler – уникальное место, где вы сможете исполнить ваши желания и закрыть любые потребности. У нас есть
                практически все: от ногтевого сервиса и brow-бара до сложных окрашиваний, косметологии и
                SPA-процедур.
            </p>
