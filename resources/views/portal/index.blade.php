...
@section('content')
        ...
        <div class="text">
            ...
            <div>
                <p>Создавая Tesler, мы вдохновлялись вами!<br>
                    Это уникальный проект, пропитанный любовью к делу и заботой о госте. Здесь каждый сможет почувствовать свою ценность, насладиться качеством и получить новую порцию уверенности в себе.

                </p>
                <p>
                    Благодаря курсам Tesler мы вырастили команду профессионалов, где каждый мастер влюблён в свою работу, постоянно самосовершенствуется, обладает невероятной эмпатией
    ...
    <div class="content two_parts_block_wrap">
        ...
        <div class="right">
            ...
            <p>
                Для нас важно, чтобы каждый гость почувствовал себя желанным. Мы позаботились о парковке, температуре воздуха
                в салоне, массажёре для ног во время долгих парикмахерских процедур, комфортных удобных креслах и, конечно, всегда рады угостить вас чашечкой идеального кофе, вкус и качество которого мы выбирали трепетно и с любовью.
                </br></br>
                Tesler – уникальное место, где вы сможете исполнить ваши желания и закрыть любые потребности. У нас есть всё: от ногтевого сервиса и brow-бара до сложных окрашиваний, косметологии и SPA-процедур.
            </p>
