<div>
    @if(!$course_app_answered_check)
        ...
        <form action=""
              wire:submit="createCourseApp(Object.fromEntries(new FormData($event.target)))"
        >
            ...
            <button wire:loading.class="loading" type="submit" class="link-bg fern">Отправить</button>
        </form>
