    ...
    <form name="add-blog-post-form"
        ...
        <div x-data="{ open: false }">
            ...
            <div x-show="!open" style="width: fit-content"
                ...
                <img style="max-height: 400px; width: auto;" src="{{$goodcategory->getFirstMediaUrl('pic_goodcategory')}}"
                     alt="">
        ...
        <div x-data="{ open: false }">
            ...
            <div x-show="!open" style="width: fit-content"
                ...
                <img style="max-height: 400px; width: auto;" src="{{$goodcategory->getFirstMediaUrl('pic_goodcategory_small')}}"
                     alt="">
                <a @click.prevent="open = true"
                   class="mt-3 mb-3 make_pic_main_page_block btn btn-outline-primary">заменить</a>
            </div>
