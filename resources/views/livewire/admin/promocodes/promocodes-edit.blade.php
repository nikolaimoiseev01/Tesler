    ...
    <div class="p-3 border-top">
        ...
        <form name="add-blog-post-form" class="mt-3" id="add-blog-post-form"
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" wire:model.live="title" name="title" class="form-control">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Процентов:</label>
                <input type="number" id="discount" wire:model.live="discount" name="discount" class="form-control">
            </div>
