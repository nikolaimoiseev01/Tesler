...
class CalcHair extends Component
{
    ...
    public function render()
    {
        ...
        $this->steps_1 = \App\Models\Calculators\CalcHair::select('step_1')->distinct()->pluck('step_1');
        $this->steps_2 = \App\Models\Calculators\CalcHair::select('step_2')->distinct()->pluck('step_2');
        $this->steps_3 = \App\Models\Calculators\CalcHair::select('step_3')->distinct()->pluck('step_3');

        $this->options = \App\Models\Calculators\CalcHair::orderBy('service_id')->get();
    ...
    public function dehydrate()
    {
        if ($this->service_id_chosen && $this->step_2 && $this->step_3) { // Если все выбрали
            $option = \App\Models\Calculators\CalcHair::where('service_id', $this->service_id_chosen)
    ...
    public function new_option_to_add()
    {
        ...
        if (empty($errors_array)) {
            ...
            if ($option) {
                ...
                \App\Models\Calculators\CalcHair::create([
